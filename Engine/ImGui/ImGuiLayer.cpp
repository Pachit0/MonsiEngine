...
namespace Monsi {
	...
	void ImGuiLayer::SetBlueThemeColors()
	{
		...
		colors[ImGuiCol_WindowBg] = ImVec4(0.08f, 0.10f, 0.14f, 1.00f);
		colors[ImGuiCol_ChildBg] = ImVec4(0.08f, 0.10f, 0.14f, 1.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.10f, 0.12f, 0.18f, 1.00f);

		colors[ImGuiCol_Border] = ImVec4(0.20f, 0.45f, 0.75f, 0.60f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);

		colors[ImGuiCol_FrameBg] = ImVec4(0.14f, 0.20f, 0.32f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.20f, 0.35f, 0.60f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.25f, 0.45f, 0.80f, 1.00f);

		colors[ImGuiCol_Button] = ImVec4(0.14f, 0.20f, 0.32f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.22f, 0.40f, 0.72f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.30f, 0.52f, 0.92f, 1.00f);

		colors[ImGuiCol_Header] = ImVec4(0.14f, 0.20f, 0.32f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.22f, 0.40f, 0.72f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.30f, 0.52f, 0.92f, 1.00f);
		...
		colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.45f, 0.75f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.35f, 0.65f, 1.00f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.45f, 0.80f, 1.00f, 1.00f);

		colors[ImGuiCol_ResizeGrip] = ImVec4(0.20f, 0.45f, 0.80f, 0.30f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.60f, 1.00f, 0.70f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.45f, 0.75f, 1.00f, 1.00f);

		colors[ImGuiCol_Tab] = ImVec4(0.12f, 0.15f, 0.22f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.22f, 0.45f, 0.90f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.18f, 0.28f, 0.45f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.12f, 0.18f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.14f, 0.20f, 0.30f, 1.00f);

		colors[ImGuiCol_DockingPreview] = ImVec4(0.20f, 0.55f, 1.00f, 0.70f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.07f, 0.08f, 0.11f, 1.00f);

		colors[ImGuiCol_PlotLines] = ImVec4(0.60f, 0.75f, 1.00f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.30f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.25f, 0.55f, 1.00f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.40f, 0.70f, 1.00f, 1.00f);

		colors[ImGuiCol_TableHeaderBg] = ImVec4(0.12f, 0.16f, 0.22f, 1.00f);
		colors[ImGuiCol_TableBorderStrong] = ImVec4(0.08f, 0.10f, 0.14f, 1.00f);
		colors[ImGuiCol_TableBorderLight] = ImVec4(0.18f, 0.22f, 0.28f, 1.00f);
		colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.00f, 1.00f, 1.00f, 0.03f);

		colors[ImGuiCol_DragDropTarget] = ImVec4(0.30f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.30f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.20f, 0.20f, 0.20f, 0.20f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.10f, 0.10f, 0.15f, 0.45f);
	}
